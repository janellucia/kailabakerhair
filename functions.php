...
function theme_setup() {
	...
	*  sizes with add_image_size. */
	...
	set_post_thumbnail_size(500, 700, true);
	add_image_size('square', 500, 700, true);
...
function hackeryou_scripts() {
  ...
  wp_enqueue_script(
    'lazyload', //handle
    get_template_directory_uri() . '/js/lazysizes.min.js', //source
    array( 'jquery', 'plugins' ), //dependencies
    null, // version number
    true //load in footer
  );
...
function portfolio_post_type() {
	...
	$labels = array(
		...
		'menu_name'             => __( 'Portfolio Post', 'text_domain' ),
		'name_admin_bar'        => __( 'Portfolio Post', 'text_domain' ),
